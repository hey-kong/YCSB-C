...
all: clean
	$(CC) $(CXXFLAGS) $(LEVELDB_DEFS) $(ROCKSDB_DEFS) ycsbc.cc $(ALL_SOURCES) -o $(EXEC) $(LEVELDB_LIBRARY) $(ROCKSDB_LIBRARY) $(LDFLAGS)

leveldb: clean
	$(CC) $(CXXFLAGS) $(LEVELDB_DEFS) ycsbc.cc $(ONLY_LEVELDB_SOURCES) -o $(EXEC) $(LEVELDB_LIBRARY) $(LDFLAGS)

rocksdb: clean
	$(CC) $(CXXFLAGS) $(ROCKSDB_DEFS) ycsbc.cc $(ONLY_ROCKSDB_SOURCES) -o $(EXEC) $(ROCKSDB_LIBRARY) $(LDFLAGS)
